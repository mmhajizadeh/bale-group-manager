...
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text:
        try:
            ...
            ۲. اگر پیام رکیک نبود، اما کاربر در متن از کلمه "غالب" استفاده کرده بود یا مستقیما از تو سوال کرده بود، یک جواب کوتاه، صمیمی، کمی شوخ و با جمله‌بندی روان و جذاب به زبان فارسی بده. اگر پیام مستقیما مربوط به تو نبود هیچ جواب نده!
            ۳. در غیر این صورت (پیام‌های عادی که کلمات ممنوعه ندارند و به تو هم ربطی ندارند، دقت کن پیامی که به تو ربط ندارد را جواب نمی دهی!)، فقط و فقط بنویس: [PASS]
